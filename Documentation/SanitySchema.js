export default {
    ...
    name: 'shoes',
    type: 'document',
    title: 'Shoes', // The title displayed in the CMS for this document
    fields: [
      {
      ...
      },
      {
        ...
        validation: (Rule) =>
          Rule.min(0) // Ensures the discount is not negative
            .max(95) // Ensures the discount does not exceed 95%
            .error('Discount percentage must be between 0 and 95.'),
      },
      {
      ...
      },
      {
        ...
        validation: (Rule) => Rule.min(0).max(10).error('Rating count must be a non-negative number.'),
      },
      {
      ...
      },
      {
        ...
        type: 'string',
        title: 'SEO Title',
        description: 'Title for SEO optimization (max 50 characters).',
        validation: (Rule) => Rule.max(50).error('SEO title cannot exceed 50 characters.'),
      },
      {
